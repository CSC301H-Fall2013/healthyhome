...
class ComplaintTestCase(TestCase):
    def setUp(self):
        # Valid Data
        Complaint.objects.create(address="61 Charles Street East, Toronto, Ontario, M5S 1K6",
                                 category="Elevator Not Working")
    ...
    def test_valid_complaints(self):
        ...
        The data validation succeeds and code checks database for created items.
